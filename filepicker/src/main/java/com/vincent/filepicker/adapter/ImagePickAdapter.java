        ...
        if (isNeedCamera && position == 0) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(IMAGE_BROWSER_INIT_INDEX,isNeedCamera ? holder.getAdapterPosition() - 1 : holder.getAdapterPosition());
                    //intent.putParcelableArrayListExtra(IMAGE_BROWSER_LIST, mList);
                    IntentCacheHelper.getInstance().putIntentValue(IMAGE_BROWSER_LIST, mList.clone());
