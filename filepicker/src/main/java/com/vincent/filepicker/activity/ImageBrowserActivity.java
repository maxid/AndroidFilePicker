...
public class ImageBrowserActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList = (ArrayList<ImageFile>) IntentCacheHelper.getInstance().getIntentValue(IMAGE_BROWSER_LIST);
    ...
    private void finishThis() {
        ...
        IntentCacheHelper.getInstance().putIntentValue(Constant.RESULT_BROWSER_IMAGE, mList.clone());
        intent.putExtra(IMAGE_BROWSER_SELECTED_NUMBER, mCurrentNumber);
        setResult(RESULT_OK, intent);
        finish();
    }

    private ArrayList<ImageFile> getSelectList(List<ImageFile> list){
